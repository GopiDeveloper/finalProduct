...
const url = "https://zoomat.herokuapp.com/reastaurants"
const menuUrl = "https://zoomat.herokuapp.com/menu"
                ...
                <div className="col-md-12">
                    <Tabs>
                        ...
                        <TabPanel>
                            ...
                            <p>
                                Manali is simply dummy text of the printing and typessetting industry.
                            </p>
                        </TabPanel>
                        <TabPanel>
                            <h2>{details.address}</h2>
                            <h2>contactno : 9347465307</h2>
                        </TabPanel>
                        <TabPanel>
